      ...
      <script src="<?=$path['js']?>/countdown.min.js"></script>
      ...
      <script src="<?=$path['js']?>/smooth-scrollbar.js"></script>
      <!-- lottie JavaScript -->
      <script src="<?=$path['js']?>/lottie.js"></script>
      <!-- am core JavaScript -->
      <script src="<?=$path['js']?>/core.js"></script>
      <!-- am charts JavaScript -->
      <script src="<?=$path['js']?>/charts.js"></script>
      <!-- am animated JavaScript -->
      <script src="<?=$path['js']?>/animated.js"></script>
      <!-- am kelly JavaScript -->
      <script src="<?=$path['js']?>/kelly.js"></script>
      <!-- am maps JavaScript -->
      <script src="<?=$path['js']?>/maps.js"></script>
      <!-- am worldLow JavaScript -->
      <script src="<?=$path['js']?>/worldLow.js"></script>
      <!-- Chart Custom JavaScript -->
      <script src="<?=$path['js']?>/chart-custom.js"></script>
      <!-- Custom JavaScript -->
